...
export default function Women() {
  ...
  return (
    <div className="container mx-auto p-6">
      {/* Page Title */}
      <h1 className="text-3xl font-bold text-purple-600 text-center my-6">Women's Category</h1>
  ...
  <div className="text-center">
    ...
    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-4">
      <div className="bg-gray-100 p-2 rounded-lg shadow">
        <img
          src="src/Images/women 3.jpeg" // Replace with real image URL
          alt="Trendy Dress"
...
{/* Images Section */}
    ...
    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-4">
      <div className="bg-gray-100 p-2 rounded-lg shadow">
        <img
          src="src/Images/Salwar.webp" // Replace with real image URL
          alt="Trendy Dress"
          className="w-full h-48 object-cover rounded-md"
        />
        <p className="mt-2 text-gray-700">Salwar Materials</p>
      </div>

      <div className="bg-gray-100 p-2 rounded-lg shadow">
        <img
          src="src/Images/BodyCone.webp" // Replace with real image URL
          alt="Casual Wear"
          className="w-full h-48 object-cover rounded-md"
        />
        <p className="mt-2 text-gray-700">BodyCones</p>
      </div>

      <div className="bg-gray-100 p-2 rounded-lg shadow">
        <img
          src="src/Images/lehanga.webp" // Replace with real image URL
          alt="Ethnic Outfit"
          className="w-full h-48 object-cover rounded-md"
        />
        <p className="mt-2 text-gray-700">Lehanga</p>
      </div>
    </div>
  </div>
);
...
const Makeup = () => (
  <div className="text-center">
    <h2 className="text-2xl font-semibold text-purple-700">Makeup</h2>
    <p className="text-gray-600 mt-2">Find the best cosmetics for a flawless look.</p>
  </div>
);
